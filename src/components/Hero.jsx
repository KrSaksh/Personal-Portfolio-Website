...
const socials = [
  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        <path d="M7.443 5.35c.639 0 1.23.05 1.77.198.541.099.984.297 1.377.544.394.247.689.594.886 1.039.197.395.296.889.296 1.481 0 .641-.148 1.185-.444 1.629-.295.444-.739.839-1.329 1.086.789.198 1.378.594 1.771 1.136.394.543.591 1.185.591 1.974 0 .642-.123 1.185-.369 1.678-.246.444-.59.839-1.033 1.136-.444.297-.936.494-1.525.642-.59.099-1.18.148-1.82.148H1V5.35h6.443zm-.394 5.54c.492 0 .886-.099 1.23-.346.344-.247.492-.642.492-1.136 0-.296-.05-.543-.148-.74-.099-.197-.247-.345-.444-.444-.197-.099-.394-.197-.64-.247-.246-.049-.492-.049-.788-.049H3.786v2.962h3.263zm.148 5.836c.296 0 .591-.05.837-.099.295-.05.541-.148.738-.296.197-.148.394-.346.492-.593.099-.247.197-.543.197-.889 0-.691-.197-1.185-.59-1.481-.395-.296-.936-.444-1.575-.444H3.786v3.802h3.411zM16.16 5.35h5.41v1.382H16.16V5.35zm6.394 8.9c0 .691-.099 1.333-.345 1.876-.247.543-.591 1.037-1.033 1.432-.443.395-.985.691-1.575.889-.59.197-1.23.296-1.918.296-.69 0-1.329-.099-1.919-.296-.59-.198-1.082-.494-1.525-.889-.443-.395-.788-.889-1.033-1.432-.246-.543-.345-1.185-.345-1.876 0-.691.099-1.333.345-1.876.245-.543.59-1.037 1.033-1.432.443-.395.935-.691 1.525-.889.59-.197 1.23-.296 1.919-.296.689 0 1.328.099 1.918.296.59.198 1.132.494 1.575.889.442.395.786.889 1.033 1.432.246.543.345 1.185.345 1.876zm-2.46 0c0-.84-.197-1.481-.59-1.975-.394-.494-.985-.74-1.722-.74-.738 0-1.328.246-1.722.74-.394.494-.59 1.135-.59 1.975 0 .839.196 1.48.59 1.974.394.494.984.74 1.722.74.737 0 1.328-.246 1.722-.74.393-.494.59-1.135.59-1.974z"/>
      </svg>
    ),
  },
  {
...
function FloatingItems({ onExplore, onAbout }) {
  ...
  return (
    <>
      {/* CV */}
      <FloatDrift x="60%" y="42%" delay={1.4} duration={9}>
        <motion.a
          href="/Kumar_Saksham_Resume.pdf"
          target="_blank"
          rel="noopener noreferrer"
          whileHover={{ background: 'rgba(255,215,0,0.2)', color: '#ffd700', borderColor: 'rgba(255,215,0,0.7)', boxShadow: '0 0 20px rgba(255,215,0,0.25)' }}
          whileTap={{ scale: 0.93 }}
          data-hover
          style={{
            fontFamily: FONT,
